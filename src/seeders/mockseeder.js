...
module.exports = {
  up: async (queryInterface) => {
    try {
      ...
      const seedUsers = [
        {
          ...
          password: await bcryptHasher('qwerty'),
          is_admin: false,
          is_parent: true,
          created_at: new Date(),
          updated_at: new Date(),
      ...
      const [userA, userB, userC, userD, userE] =
      ...
      const seededItemsArr = await queryInterface.bulkInsert(
        'items',
        seedItems,
        { returning: true }
      );
      ...
      const [ptA, ptE, ptAT1, ptAT2, ptMT1, ptMT2, ptSM, ftM] =
        seededEmployment;
      // seed parent data
      const seedParents = [
        {
      ...
      const [parentA, parentB, parentC] = await queryInterface.bulkInsert(
        'parents',
        seedParents,
        { returning: true }
      );
      ...
      const seedStudents = [
        ...
        {
          name: 'Child B1',
          dob: new Date('2011/1/1'),
          additional_info: 'Likes oreos',
          parent_id: userB.id,
          created_at: new Date(),
          updated_at: new Date(),
        },
      ...
      const [childA, childB1, childB2, childC] =
      ...
      const seedCredits = [
        {
          ...
          value: 700,
          credit_total: 8,
          purchase_date: new Date('2019/07/30'),
          expiry: new Date('2021/07/30'),
          item_id: 3,
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          ...
          value: 380,
          credit_total: 4,
          purchase_date: new Date('2019/08/10'),
          expiry: new Date('2021/08/10'),
          item_id: 2,
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          ...
          value: 700,
          credit_total: 8,
          purchase_date: new Date('2019/12/31'),
          expiry: new Date('2021/12/31'),
          item_id: 3,
          created_at: new Date(),
          updated_at: new Date(),
        },
        ...
        },
        {
          ...
          value: 380,
          credit_total: 4,
          purchase_date: new Date('2019/06/30'),
          expiry: new Date('2021/06/30'),
          item_id: 2,
          created_at: new Date(),
          updated_at: new Date(),
        },
        {
          ...
          value: 380,
          credit_total: 4,
          purchase_date: new Date('2021/12/31'),
          expiry: new Date('2021/12/31'),
          item_id: 2,
          created_at: new Date(),
          updated_at: new Date(),
        ...
        },
        {
          ...
          value: 1980,
          credit_total: 24,
          purchase_date: new Date('2019/10/01'),
          expiry: new Date('2021/10/01'),
          item_id: 4,
          created_at: new Date(),
          updated_at: new Date(),
        },
      ...
      const seededInstructorsArr = await queryInterface.bulkInsert(
        'instructors',
        seedInstructors,
        { returning: true }
      );
      ...
      const ScratchLevels = [
        'Tier 1 - Classic Arcade',
        'Tier 1 - Animal Planet',
        'Tier 1 - Food Hunt',
        'Tier 2 - Arcade',
        'Tier 2 - Reaction Speed',
        'Tier 2 - Sports & Racing',
      ];
      const learningPathsName = ['WeDo', 'EV3', 'Arduino', 'Python', 'Scratch'];
      const learningPathsArr = [
        WeDoLevels,
        EV3Levels,
        ArduinoLevels,
        PythonLevels,
      ...
      const seededCoursetype = await queryInterface.bulkInsert(
        'coursetypes',
        seedCourseTypes,
        { returning: true }
      );
      ...
      for (let i = 0; i < cDates.length; i += 1) {
        ...
        const randCourseType =
          seededCoursetype[Math.floor(Math.random() * seededCoursetype.length)];

        //  add course
        const instructorOption = i % 2;
        const instructorArrOptions = [
          { id: 1, name: 'UserD' },
          { id: 2, name: 'UserE' },
        ];
        seedCourses.push({
          ...
          instructor: JSON.stringify({
            instructor: [instructorArrOptions[instructorOption]],
          }),
      ...
      for (let i = 0; i < seededSessions.length; i += 1) {
        ...
        seedAssignments.push({
          ...
          rate: seededEmployment[seededInstructorsArr[instructorId].rate_id - 1]
            .rate,
          role: 'main',
          created_at: new Date(),
          updated_at: new Date(),
